...
void SettingsDialog::createAgentTab() {
    ...
    context_limit_spin_ = new QSpinBox();
    context_limit_spin_->setRange(5000, 200000);
    context_limit_spin_->setSingleStep(10000);
    context_limit_spin_->setToolTip("Token limit before conversation consolidation is triggered");
    connect(context_limit_spin_, QOverload<int>::of(&QSpinBox::valueChanged),
            this, &SettingsDialog::onSettingChanged);
    agent_layout->addRow("Context Limit (tokens):", context_limit_spin_);
...
void SettingsDialog::loadSettings() {
    ...
    context_limit_spin_->setValue(config.agent.context_limit);
...
void SettingsDialog::applySettings() {
    ...
    config.agent.context_limit = context_limit_spin_->value();
