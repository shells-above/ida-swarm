...
public:
    ...
    std::optional<api::OAuthCredentials> get_credentials();
    
    // Get cached credentials without re-reading
    std::optional<api::OAuthCredentials> get_cached_credentials() const;
...
private:
    ...
    // Cached credentials
    std::optional<api::OAuthCredentials> cached_credentials;
    ...
    api::OAuthCredentials extract_oauth_credentials(const json& creds_json) const;
